...
class StreamDelete extends React.Component {
  ...
  renderContent = () => {
    if (!this.props.stream) {
      return 'Are you sure you want tot delete this stream?';
    }
  ...
  render() {
    return (
      <div>
        StreamDelete
        <Modal title="Delte Stream" content={this.renderContent()} actions={this.renderActions()} onDismiss={() => history.push('/')} />
      </div>
    );
  }
}
